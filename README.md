...
const App = () => {
  ...
  // Placeholder for user's photos. Replace these URLs with actual image URLs.
  // Visita la sección "Guía de Personalización" para instrucciones sobre cómo agregar tus fotos.
  const userPhotos = [
    "https://placehold.co/400x300/1a202c/a0aec0?text=Foto+Cristian+1",
    "https://placehold.co/400x300/1a202c/a0aec0?text=Foto+Cristian+2",
    "https://placehold.co/400x300/1a202c/a0aec0?text=Foto+Cristian+3",
    "https://placehold.co/400x300/1a202c/a0aec0?text=Foto+Cristian+4",
    "https://placehold.co/400x300/1a202c/a0aec0?text=Foto+Cristian+5",
    "https://placehold.co/400x300/1a202c/a0aec0?text=Foto+Cristian+6",
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white font-inter antialiased flex flex-col items-center justify-center overflow-x-hidden">
      {/* Tailwind CSS CDN - Ensure this is loaded in your public/index.html or equivalent */}
      ...
      {/* SEO Meta Tags (for demonstration, ideally in public/index.html) */}
      ...
      <meta property="og:image" content="https://placehold.co/1200x630/000000/FFFFFF?text=Invitacion+Cristian+Caleb" /> {/* Placeholder image */}
      <meta property="og:url" content="https://your-invitation-url.netlify.app" /> {/* Replace with actual URL */}
      ...
      {showWelcome ? (
        <div className="welcome-screen flex flex-col items-center justify-center text-center p-6 bg-gray-950 w-full h-screen animate-fadeIn">
          ...
          <p className="text-2xl md:text-4xl font-semibold text-white leading-relaxed max-w-4xl animate-slideUp delay-1s neon-text">
            Prepárate para ser testigo de un momento mágico, la celebración de los quince años de mi hijo Cristian Caleb. Un hito que marca el inicio de una nueva etapa, y tu presencia es un regalo inestimable que atesoramos en lo más profundo de nuestro corazón. ¡Tu alegría es parte fundamental de su historia!
          </p>
          <button
        ...
        <div className="main-invitation w-full max-w-5xl mx-auto p-6 md:p-10 lg:p-12 animate-fadeIn delay-1s">
          ...
          <section className="mb-16 bg-gray-800 p-8 rounded-xl shadow-xl border border-blue-700 animate-slideInUp">
            ...
            <p className="text-lg text-gray-300 mb-6">
              Por favor, ayúdanos a planificar este día tan importante confirmando tu asistencia antes del <span className="font-semibold text-cyan-300">15 de julio del 2025</span>.
            </p>
            <form action="https://formspree.io/f/yourformid" method="POST" className="space-y-6"> {/* Replace 'yourformid' with your actual Formspree form ID */}
              <div>
                ...
                <input
                  ...
                  id="name"
                  name="name"
                  className="shadow appearance-none border border-gray-700 rounded-lg w-full py-3 px-4 bg-gray-900 text-white leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="Tu nombre completo"
                  required
                />
              </div>
              <div>
                <label htmlFor="companions" className="block text-gray-400 text-sm font-bold mb-2">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-purple-600 to-blue-700 hover:from-purple-700 hover:to-blue-800 text-white font-bold py-3 px-4 rounded-lg shadow-lg transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-purple-500/50"
              >
          ...
          <section className="mb-16 bg-gray-800 p-8 rounded-xl shadow-xl border border-blue-700 animate-slideInRight">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* User's photos will go here. Replace the placeholder URLs in the userPhotos array above with your actual image URLs. */}
              {userPhotos.map((imageUrl, index) => (
                <div key={index} className="rounded-lg overflow-hidden shadow-lg transform hover:scale-105 transition-transform duration-300">
                  <img
                    ...
                    onError={(e) => { e.target.onerror = null; e.target.src = 'https://placehold.co/400x300/1a202c/a0aec0?text=Error+Carga'; }} // Fallback for broken images
                  />
                </div>
              ))}
            </div>
          ...
          <section className="mb-16 bg-gray-800 p-8 rounded-xl shadow-xl border border-purple-700 animate-slideInUp">
            ...
            <div className="aspect-w-16 aspect-h-9 w-full rounded-lg overflow-hidden shadow-xl">
              {/* Embedded Spotify Playlist for Reggaeton */}
              {/* Visita la sección "Guía de Personalización" para instrucciones sobre cómo agregar tu playlist. */}
              <iframe
                src="https://open.spotify.com/embed/playlist/37i9dQZF1DXafK5K30Q8Jc?utm_source=generator&theme=0" // Generic Reggaeton playlist from Spotify
                width="100%"
                height="352"
                frameBorder="0"
                allowFullScreen=""
            ...
            <p className="text-center text-gray-400 text-sm mt-6">
              ¡Prepárate para bailar con la mejor selección de reggaetón!
            </p>
          </section>
          ...
          <section className="mb-16 bg-gray-800 p-8 rounded-xl shadow-xl border border-blue-700 animate-slideInLeft">
            ...
            <p className="text-xl text-gray-300 leading-relaxed italic">
              ...
              Estamos increíblemente emocionados de celebrar los quince años de nuestro amado hijo, Cristian Caleb. Ha sido un viaje maravilloso verlo crecer y convertirse en el joven extraordinario que es hoy. Su alegría, su espíritu y su amor iluminan nuestras vidas cada día.
              Esperamos compartir este momento tan significativo con todos ustedes y crear recuerdos inolvidables juntos. ¡Gracias por ser parte de su historia y por acompañarnos en este día tan especial!"
            </p>
      ...
      <style>{`
        ...
        /* Reduced luminosity for neon effects */
        .neon-text {
          text-shadow: 0 0 2px #0ff, 0 0 4px #0ff, 0 0 8px #0ff; /* Further reduced values */
        }

        .neon-text-large {
          text-shadow: 0 0 3px #0ff, 0 0 6px #0ff, 0 0 9px #0ff, 0 0 15px #0ff; /* Further reduced values */
        }

        .neon-number {
          text-shadow: 0 0 2px #0ff, 0 0 4px #0ff, 0 0 6px #0ff; /* Further reduced values */
        }

        /* Specific style for green neon text with less glow */
        .neon-text-green {
          text-shadow: 0 0 1px #84cc16, 0 0 2px #84cc16, 0 0 4px #84cc16; /* Subtle green glow */
        }
        ...
        @keyframes glow {
          0%, 100% { text-shadow: 0 0 2px #0ff, 0 0 4px #0ff, 0 0 8px #0ff; } /* Further reduced values */
          50% { text-shadow: 0 0 4px #0ff, 0 0 8px #0ff, 0 0 16px #0ff, 0 0 24px #0ff; } /* Further reduced values */
        }
        .animate-glow {
